  ...
  return (
    <ArticleContainer className='article'>
      ...
      <div className='content'>
        ...
        <p className='texts'>
          Aside from programming, I am passionate about environmental safety and protection. I am always looking for ways to combine my interest in technology and environmental protection, and I believe that software development can play a significant role in achieving this goal.
